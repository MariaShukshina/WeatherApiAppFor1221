package com.mshukshina.weatherapiapp.ui
...
import com.mshukshina.weatherapiapp.databinding.ActivityMainBinding
import com.mshukshina.weatherapiapp.utils.Constants
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.searchButton.setOnClickListener {
            if(viewModel.internetConnectionState.value == true) {
                viewModel.getWeather(searchQuery, 5, Constants.API_KEY)
            } else {
